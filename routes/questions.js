...
router.post('/editCategory', function (req, res) {    
    ...
    constructedQueries = ["INSERT INTO Questions (titleID,title, qStatement, qAnswer) VALUES (" + req.body.titleID + ",'" + req.body.title + "','" +req.body.qStatement1 + "','" + req.body.qAnswer1 + "');",
    "INSERT INTO Questions (titleID,title, qStatement, qAnswer) VALUES (" + req.body.titleID + ",'" + req.body.title + "','" +req.body.qStatement2 +   "','" + req.body.qAnswer2 + "');",
    "INSERT INTO Questions (titleID,title, qStatement, qAnswer) VALUES (" + req.body.titleID + ",'" + req.body.title + "','" +req.body.qStatement3 +   "','" + req.body.qAnswer3 + "');",
    "INSERT INTO Questions (titleID,title, qStatement, qAnswer) VALUES (" + req.body.titleID + ",'" + req.body.title + "','" +req.body.qStatement4 +   "','" + req.body.qAnswer4 + "');",
    "INSERT INTO Questions (titleID,title, qStatement, qAnswer) VALUES (" + req.body.titleID + ",'" + req.body.title + "','" +req.body.qStatement5 +   "','" + req.body.qAnswer5 + "');"]
...
router.post('/deleteCategory',(req,res)=>{
    ...
    console.log(req.body)
        ...
        con.query("DELETE FROM Questions WHERE titleID = ?", req.body.titleID,
            ...
            console.log("printing before:",categoryList)
            var index = categoryList.indexOf(parseInt(req.body.titleID));
			if (index > -1) {
			  categoryList.splice(index, 1);
            }
            console.log("printing after:",categoryList)
			
			index = allCategory.indexOf(parseInt(req.body.titleID));
			if (index > -1){
